...
const SettingPage_IsValidCountryCode_Function = (value) => {
...
const SettingPage_ConfirmCountry_Function = async () => {
  ...
  if (!SettingPage_IsValidCountryCode_Function(value)) {
    props.App_Notify_Function('warning', '请输入正确的国家代码（ISO 3166-1 Alpha-2）');
    return;
  }
